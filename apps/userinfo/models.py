...
SALT = getattr(settings, "EMAIL_TOKEN_SALT", "py_web")
...
class EmailVerifyRecord(models.Model):
    # 验证码
    code = models.CharField(max_length=128, verbose_name=u"验证码")
    email = models.EmailField(max_length=128, verbose_name=u"邮箱")
    # 包含注册验证和找回验证
    send_type = models.CharField(verbose_name=u"验证码类型", max_length=64,
